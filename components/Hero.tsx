      ...
      <div className="container-main relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <br />
            <span className="text-gradient-green">România — 24/7.</span>
          </h1>
          ...
          >
            Construim sisteme AI care preiau lead-urile, follow-up-urile și
            operațiunile automat — ca tu să te focusezi pe creștere, nu pe muncă repetitivă.
          </p>
