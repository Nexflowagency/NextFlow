---
name: seo-geo-aeo
description: Single-pass combined SEO + GEO + AEO audit of a live URL that ends in a client-ready Word/PDF deliverable. Crawls several pages and scores traditional search (titles, meta, headings, schema, internal links), generative-engine readiness (E-E-A-T, entity clarity, factual density) and answer-engine readiness (FAQ/HowTo schema, question headings, snippet formatting) in one report. Use when the user explicitly wants an SEO/GEO/AEO report document to hand to a client; for iterative in-repo optimization use seo, seo-audit or geo-audit instead.
---
