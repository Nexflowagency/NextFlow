...
name: geo
description: >
  Router for the geo-* Generative Engine Optimization skill family (geo-audit,
  geo-citability, geo-crawlers, geo-llmstxt, geo-schema, geo-brand-mentions,
  geo-platform-optimizer, geo-report, geo-proposal, geo-prospect and more).
  Use only to pick the right geo-* skill for an AI-search task, or for the
  agency workflow around them (prospect tracking, proposals, monthly delta
  reports). Invoke the specific geo-* skill directly when you already know it.
